...
class RecipeView extends View {
  ...
  // Add event listeners for hashchange and load events to update recipe
  ...
  // Then use the closest method to find the closest btn--update-servings clicked
  ...
  // Event listener to handle bookmark clicks
